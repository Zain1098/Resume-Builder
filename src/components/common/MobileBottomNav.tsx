...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 block border-t border-border-default bg-surface/95 backdrop-blur-md lg:hidden print:hidden safe-area-bottom">
      <div className="grid grid-cols-5 h-14">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon className={`h-5 w-5 ${isActive ? "scale-105 text-primary" : ""}`} />
